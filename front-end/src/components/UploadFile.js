...
export const UploadFile = ({setResult, setSelected}) =>{
    ...
    async function handleSubmit(event) {
        ...
        {(Array.from(files)).map(async file => {
            try{
                let url = 'http://127.0.0.1:8000/api/v1/magic/uploaddoc/' + localStorage.getItem("user_ont");
    ...
    async function deleteDocs(e){
        ...
        try{
          let url = 'http://127.0.0.1:8000/api/v1/magic/deletedocs/' + localStorage.getItem("user_ont");
